...
<!-- 			<li class="bu03">마감포인트</li> -->
			...
			<tbody>
				<tr>
					<td>
						...
						<div class="btn_w">
							<a href="/content/poll_join.php?b_num=178" target="_blank" class="con_btn navy">설문시작하기</a>
						</div>				
	...
	<div class="board_button">
		...
		<div class="fr pt10">
			...
			<span><a href="/content/01_01.php" class="cbtn cbtn_g">설문리스트</a></span>
		</div>
	</div>
	<!-- //버튼 -->
	...
	<div class="guide">
		<ul>
			<li>
				...
				<div class="desc">
					<p>아래 내용과 같이 설문조사에 참여했을 경우, 포인트를 지급하지 않고, 통보 없이 회원 탈퇴 처리가 되므로 주의하시기 바랍니다.</p>
					<ul class="list">
			...
			<li>
				...
				<div class="desc">
					<p>설문조사 참여 중 주의사항</p>
					<ul class="list">
						<li>설문조사 참여 도중에 <span class="st">뒤로가기</span> 혹은 <span class="st">새로 고침</span>을 누르시면 설문이 중단되거나 포인트가 정상적으로 지급되지 않으며, 설문조사 페이지가 인터넷 연결 상태에 따라 늦게 로딩될 수도 있사오니 조금만 기다려주시기바랍니다.</li>
					</ul>
				</div>
			</li>
			<li>
			...
			<li>
				...
				<div class="desc">
					<p>회원님께서 응답하신 내용은 통계데이터로만 활용되며, 개인정보를 설문조사를 통하여 입력 받거나 제공하지 않습니다.</p>
				</div>
			</li>
			<li>
				<span class="num">05</span>
				<div class="desc">
					<p>설문조사 완료 후 회원님의 설문응답지를 다시 검증하여, 응답하신 결과에 따라 확인과정이 있을 수 있습니다.</p>
				</div>
			</li>
		</ul>
	</div>
